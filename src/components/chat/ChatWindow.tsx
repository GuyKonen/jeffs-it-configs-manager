    ...
    <div className="h-full bg-white dark:bg-gray-800">
      ...
      <div className="flex items-center justify-center p-3 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Jeff</h1>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto p-4">
          {messages.length === 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">Jeff</h2>
